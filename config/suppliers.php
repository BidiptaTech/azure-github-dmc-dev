...
return [
    ...
    'mg_bedbank' => [
        ...
        'fields' => [
            ...
            'hotel_codes' => ['env' => 'MG_BEDBANK_HOTEL_CODES', 'label' => 'Hotel Codes (optional, comma-separated)', 'type' => 'text'],
            'currency' => ['env' => 'MG_BEDBANK_CURRENCY', 'label' => 'Requested Currency', 'type' => 'text', 'default' => 'INR'],
