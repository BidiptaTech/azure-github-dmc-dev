...
class Kernel extends HttpKernel
{
    ...
    /**
     * Route middleware groups (Laravel 11).
     *
     * NOTE: With Application::configure()->withMiddleware() in bootstrap/app.php,
     * these groups are NOT the runtime source of truth. Configure web/api middleware
