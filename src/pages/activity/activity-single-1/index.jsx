...
const metadata = {
  title:
    "Entry/Exit Port Vehicle || Travclicks - Travel Technology Transformed",
  description: "Travclicks - Travel Technology Transformed",
};

const ActivitySingleV2Dynamic = () => {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-4 d-flex">
              <SidebarRight1 activity={activity} style={{ flex: 1 }} />
            </div>
          </div>
        </div>
      </section>
...
export default ActivitySingleV2Dynamic;
