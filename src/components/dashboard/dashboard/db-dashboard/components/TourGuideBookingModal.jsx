...
const TourGuideBookingModal = ({ open, onClose, booking }) => {
                  ...
                  >
                    {booking?.image ? (
                      <CardMedia
                        component="img"
                        image={booking.image}
                        alt={booking?.guide_name || "Tour Guide"}
                        sx={{
                          width: "100%",
                          height: "100%",
                          objectFit: "cover",
                    ...
                    >
                      ...
                      <Box sx={{ mt: 2 }}>
                        ...
                        >
                          ...
                          >
                            Location: {booking.entrypickup || "N/A"}
                          </Typography>
                        </Box>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      <Box
                        sx={{ display: "flex", alignItems: "center", mb: 1 }}
                      >
                        <TimelineIcon sx={{ color: "#3554D1", mr: 1 }} />
                        <Typography
                          variant="subtitle1"
                          sx={{ fontWeight: "bold" }}
                        >
                      ...
                      <Box sx={{ mt: 2 }}>
                        ...
                        >
                          ...
                          <Box>
                            ...
                            <Typography variant="body2" color="textSecondary">
                              Guided tour with personalized experience
                            </Typography>
                          </Box>
                        </Box>
                      </Box>
...
export default TourGuideBookingModal;
