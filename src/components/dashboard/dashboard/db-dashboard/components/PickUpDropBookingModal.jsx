...
const PickUpDropBookingModal = ({ open, onClose, booking }) => {
  ...
  // Determine if it's an entry or exit port booking
  const isExitPort = booking.exitpickup !== undefined;
  const bookingType = isExitPort ? "Exit Port" : "Entry Port";
  ...
  const getTypeIcon = () => {
    if (isExitPort) {
      ...
      return <FlightLandIcon fontSize="large" />;
    }
  };
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      ...
                      >
                        {isExitPort ? (
                          <FlightTakeoffIcon sx={{ color: "#3554D1", mr: 1 }} />
                        ) : (
                          <FlightLandIcon sx={{ color: "#3554D1", mr: 1 }} />
                        )}
                        <Typography
                          variant="subtitle1"
                      ...
                      <Box sx={{ mt: 2 }}>
                        ...
                        >
                          ...
                          >
                            {booking.entrypickup || booking.exitpickup || "N/A"}
                          </Typography>
                        </Box>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      <Box
                        sx={{ display: "flex", alignItems: "center", mb: 1 }}
                      >
                        <LocationCityIcon sx={{ color: "#3554D1", mr: 1 }} />
                        <Typography
                          variant="subtitle1"
                          sx={{ fontWeight: "bold" }}
                        >
                      ...
                      >
                        ...
                        <Typography
                          ...
                          sx={{ fontWeight: "medium" }}
                        >
                          {booking.entrydropoff || booking.exitdropoff || "N/A"}
                        </Typography>
                      </Box>
                    </Paper>
                  </Grid>
...
export default PickUpDropBookingModal;
