...
const formatDestinationLabel = (destination, countryMappings = {}) => {
  ...
  return destination
    ...
    .map((code) => {
      ...
      if (codeToName[trimmedCode.toLowerCase()]) return codeToName[trimmedCode.toLowerCase()];
                        ...
                        <td className="tour-details-column">
                          ...
                          >
                            ...
                            >
                              ...
                              {formatDestinationLabel(list.destination, { codeToName: countryMap })}
                            </span>
                            <div
                              style={{
                                display: "flex",
                            ...
                            >
                              ...
                              <Tooltip title={`${list.total_pax || 0} pax`} arrow placement="top">
                                ...
                                >
                                  <People sx={{ fontSize: "13px", color: "#b45309" }} />
                                  {list.total_pax}
                                </span>
                              </Tooltip>
                            </div>
