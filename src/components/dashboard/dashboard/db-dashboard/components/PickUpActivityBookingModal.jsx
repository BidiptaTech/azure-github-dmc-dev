...
const PickUpActivityBookingModal = ({ open, onClose, booking }) => {
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Typography variant="h6" sx={{ fontWeight: 'bold' }}>Activity Booking Details</Typography>
        </Box>
        <IconButton
          edge="end"
          color="inherit"
      ...
      <DialogContent sx={{ mt: 2, position: "relative", p: 3 }}>
        <Grid container spacing={3}>
          {/* Activity Image and Basic Info Card */}
          <Grid item xs={12}>
            <Card 
              elevation={2}
              sx={{ 
                ...
                <Grid item xs={12} md={8}>
                  <CardContent sx={{ p: 3 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                      <LocalActivityIcon sx={{ color: '#3554D1', mr: 1, fontSize: 28 }} />
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                        <AttractionIcon sx={{ color: '#3554D1', mr: 1 }} />
                      ...
                      <Box sx={{ mt: 2 }}>
                        <Chip 
                          icon={<AttractionIcon />} 
                          label={capitalizeFirstLetter(booking.service_details?.item_type || "")}
                          color="primary"
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
                          ...
                          <Typography variant="body1" sx={{ fontWeight: 'medium' }}>
                            Duration: {booking.service_details?.duration || "N/A"}
                          </Typography>
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
                          ...
                          <Typography variant="body1">
                            Schedule: {booking.service_details?.schedule || "N/A"}
                          </Typography>
                        </Box>

                        {booking.service_details?.transport_mode && (
                          <Box sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
                            <DirectionsCarIcon sx={{ color: '#3554D1', mr: 1 }} />
                            <Typography variant="body1">
                              Transport Mode: {capitalizeFirstLetter(booking.service_details?.transport_mode)}
                            </Typography>
                          </Box>
                        )}
                      </Box>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  <Box sx={{ 
                    ...
                    <DescriptionIcon sx={{ color: '#3554D1', fontSize: 28 }} />
                    <Typography variant="h6" sx={{ fontWeight: 'bold' }}>
                      Activity Description
                    </Typography>
                  </Box>
...
export default PickUpActivityBookingModal; 