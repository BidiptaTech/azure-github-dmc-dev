...
const ExitPortBooking = ({
  ...
  return (
    ...
    >
      ...
      {/* Vehicle Image and Details Section - Styled like EntryPortPointBooking */}
      <Card
        elevation={2}
        sx={{
          borderRadius: "12px",
      ...
      {/* Booking Details Section - Styled like EntryPortPointBooking */}
      <Box sx={{ mb: 2.5 }}>
        <Typography
          variant="subtitle1"
          sx={{
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {bookingDetails.exitpickup || "Not specified"}
                      </Typography>
                    </Box>
                  </Box>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {bookingDetails.exitdropoff || "Not specified"}
                      </Typography>
                    </Box>
                  </Box>
      ...
      {/* Total Price Summary - Keep the existing price card or replace it if needed */}
      <Card
        elevation={2}
        sx={{
          mt: 2,
...
export default ExitPortBooking;
