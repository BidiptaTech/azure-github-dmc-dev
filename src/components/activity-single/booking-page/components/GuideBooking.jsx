...
const GuideBooking = ({
  ...
  // Format functions to match TravelHourlyBooking
  ...
  return (
    ...
    >
      {/* Header Section with Gradient Background - Styled like TravelHourlyBooking */}
      {/* <Box
        sx={{
          background: "linear-gradient(135deg, #3554D1 0%, #5073FB 100%)", // Teal gradient for Guide
          borderRadius: "8px",
          p: 2,
          mb: 2.5,
          color: "white",
      ...
      >
        ...
        <Chip
          label={bookingDetails.experience || "Professional"}
          size="small"
          sx={{
      ...
      {/* Guide Image and Details Section - Styled like TravelHourlyBooking */}
      <Card
        elevation={2}
        sx={{
          borderRadius: "12px",
          ...
          >
            <CardMedia
              ...
              image={
                ...
                bookingDetails.guideImage ||
                "/placeholder-guide.jpg"
              }
              alt={bookingDetails.guideName || "Tour Guide"}
              sx={{
                width: "100%",
                height: "100%",
                position: "absolute",
            ...
            {bookingDetails.guideName && (
              ...
              >
                <Chip
                  label={bookingDetails.guideName || bookingDetails.guide_name}
                  sx={{
          ...
          <Grid item xs={12} md={8}>
            <CardContent sx={{ p: { xs: 2, md: 2.5 } }}>
              <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                <TourIcon sx={{ color: "#3554D1", mr: 1, fontSize: 20 }} />
                <Typography
                  variant="h6"
                  sx={{ fontWeight: "bold", fontSize: "1.1rem" }}
                >
              ...
              <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
                ...
                {bookingDetails.languages && (
                  <Chip
                    size="small"
                    label={bookingDetails.languages}
                    sx={{
                      height: "22px",
                      fontSize: "0.75rem",
                      fontWeight: 500,
              ...
              <Box
                sx={{
                  p: 1.5,
                  backgroundColor: "rgba(0, 150, 136, 0.03)",
                  borderRadius: "8px",
      ...
      {/* Replace the "Original Content in a Card" section with this new Booking Details section */}
      <Card
        elevation={2}
        sx={{
          borderRadius: "12px",
      ...
      >
        {/* START OF NEW BOOKING DETAILS SECTION */}
        <Box sx={{ mb: 2.5 }}>
          <Card elevation={2} sx={{ borderRadius: "10px", mb: 2.5 }}>
            <Box
              sx={{
                py: 1.5,
                px: 2,
                background: "linear-gradient(135deg, #3554D1 0%, #5073FB 100%)", // Updated to teal gradient
                color: "white",
              }}
            >
              <Typography
                    ...
                    >
                      ...
                      <Grid container spacing={1.5}>
                        <Grid item xs={12}>
                          ...
                          >
                            {bookingDetails.userInfo?.fullName ||
                              "Not specified"}
                          </Typography>
                        </Grid>
      ...
      {/* Price Summary Section - Styled like TravelHourlyBooking */}
      <Card
        elevation={2}
        sx={{
          mt: 2,
          ...
          background:
            "linear-gradient(135deg, rgba(0, 150, 136, 0.03) 0%, rgba(0, 150, 136, 0.08) 100%)", // Updated to teal theme
        }}
      >
        <CardContent sx={{ p: 2 }}>
          <Typography
          ...
          >
            <Box
              ...
              sx={{
                ...
                height: 26,
                borderRadius: "50%",
                backgroundColor: "#3554D1", // Updated to teal
                color: "white",
                mr: 1,
                fontSize: "0.9rem",
              }}
                ...
                <Grid item xs={12} md={6}>
                  <Paper
                    ...
                    sx={{
                      ...
                      borderRadius: "8px",
                      bgcolor: "rgba(255,255,255,0.8)",
                      border: "1px solid rgba(0, 150, 136, 0.1)", // Updated to teal
                    }}
                  >
                    <Box
                      sx={{
