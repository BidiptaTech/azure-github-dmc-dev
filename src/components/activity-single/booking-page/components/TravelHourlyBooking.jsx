...
const TravelHourlyBooking = ({
  ...
  // Format functions to match ExitPortBooking
  ...
  return (
    ...
    >
      {/* Header Section with Gradient Background - Styled like ExitPortBooking */}
      <Box
        sx={{
          background: "linear-gradient(135deg, #3554D1 0%, #5073FB 100%)", // Purple gradient for Hourly
          borderRadius: "8px",
          p: 2,
          mb: 2.5,
          color: "white",
      ...
      {/* Vehicle Image and Details Section - Styled like ExitPortBooking */}
      <Card
        elevation={2}
        sx={{
          borderRadius: "12px",
          ...
          <Grid item xs={12} md={8}>
            <CardContent sx={{ p: { xs: 2, md: 2.5 } }}>
              ...
              <Box
                sx={{
                  p: 1.5,
                  backgroundColor: "rgba(98, 0, 234, 0.03)",
                  borderRadius: "8px",
      ...
      {/* Remaining Card with Existing Details */}
      <Card
        elevation={2}
        sx={{
          borderRadius: "12px",
      ...
      >
        ...
        <Box sx={{ mb: 2.5 }}>
          ...
          >
            <TimerIcon sx={{ mr: 1, color: "#3554D1", fontSize: 20 }} />
            Tour Details
          </Typography> */}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {bookingDetails.entrydropoff || "Local city tour"}
                        </Typography>
                      </Box>
                    </Box>
        ...
        {/* END OF NEW BOOKING DETAILS SECTION */}

        {/* Keep the original rest of the content */}
        <CardContent>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              {/* Price Summary Section - Styled like ExitPortBooking */}
              <Card
                elevation={2}
                sx={{
                  mt: 2,
                  ...
                  background:
                    "linear-gradient(135deg, rgba(98, 0, 234, 0.03) 0%, rgba(98, 0, 234, 0.08) 100%)",
                }}
              >
                <CardContent sx={{ p: 2 }}>
                  <Typography
...
export default TravelHourlyBooking;
