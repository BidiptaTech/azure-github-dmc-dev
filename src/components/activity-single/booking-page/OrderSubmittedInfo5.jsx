...
//   // Get response from both slices
//   const pickupDropResponse = useSelector((state) => state.pickupDrop.response);
//   console.log(' pickupDropResponse  pickupDropResponse  pickupDropResponse', pickupDropResponse);

//   const customerInfoResponse = useSelector((state) => state.customerInfo?.bookingResponse);
//   console.log('customerInfoResponse 11',customerInfoResponse);
//   const bookingResponse11 = useSelector((state) => state.pickupDrop.response);
//   console.log('bookingResponse11 11',bookingResponse11);
...
//   // Simplify response selection
//   const bookingResponse = customerInfoResponse?.data?.[0] || pickupDropResponse?.data?.[0];
//   console.log('bookingResponse 1233',bookingResponse);

//   console.log('Type:', type);
//   console.log('Pickup Drop Response:', pickupDropResponse);
//   console.log('Customer Info Response:', customerInfoResponse);
//   console.log('Selected Response:', bookingResponse);
...
//   const bookingData = {
//     booking_id: bookingResponse.booking_id || bookingResponse.id,
//     bookingDate: bookingResponse.bookingDate,
//     totalPrice: bookingResponse.totalPrice || bookingResponse.price || 0,
//     customerInfo: bookingResponse.customerInfo || {},
//     message: bookingResponse.message || "Booking successful",
//     type: bookingResponse.type || type,
//   };
...
//   const calculatedTotalPrice = price * exchangeRate;
//   const calculatedTotalPriceInUSD = price * usdExchangeRate;
...
//       "exitport": "Exit Port",
//       "travelpoint": "LocalTour",
//       "travelhourly": "LocalTour",
//       "guide": "Tour Guide"
//     };

//     const serviceType = typeMapping[type] || type;
//     return `${serviceType} booking successful`;
//   };

//   const handleClick = () => {
//     const navigationMap = {
//       "entryport": "/dashboard/db-dashboard/pickupdrop",
//       "exitport": "/dashboard/db-dashboard/pickupdrop",
//       "travelpoint": "/dashboard/db-dashboard/localtransfer",
//       "travelhourly": "/dashboard/db-dashboard/localtransfer",
//       "guide": "/dashboard/db-dashboard/tourguide"
//     };

//     navigate(navigationMap[type] || "/dashboard");
//   };
...
//                 {formatMessage(bookingData.message, bookingData.type)}
//               </div>
...
//                       ? dayjs(bookingData.bookingDate).format("DD MMM YYYY")
//                       : "Date not available"}
//                   </div>
//                 </div>
//                 <div className="col-lg-3 col-md-6">
//                   <div className="text-15 lh-12">Total</div>
//                   <div className="text-15 lh-12 fw-500 text-blue-1 mt-10" style={{ fontWeight: "700" }}>
//                     {currencyCode} {calculatedTotalPrice.toFixed(2)}
//                   </div>
//                   <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
//                     {usdCurrencyCode} {calculatedTotalPriceInUSD.toFixed(2)}
//                   </div>
//                   <div className="text-15 lh-12 fw-500 text-blue-1 mt-10">
//                     SGD {price.toFixed(2)}
//                   </div>
...
//                       {bookingData.customerInfo?.fullName || "FullName not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.email || "No email available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.phone || "Phone Number not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.address1 || "Address not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.address2 || "Address not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.city || "City not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.state || "State not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.zip || "Pincode not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.country || "Country not available"}
//                     </div>
//                   </div>
//                 </div>
//                 <div className="col-12">
...
//                     <div className="text-15 lh-16 fw-500 text-blue-1">
//                       {bookingData.customerInfo?.specialRequests || "Not available"}
//                     </div>
//                   </div>
//                 </div>
//               </div>
