...
const Index5 = () => {
  ...
  const selectedDate = useSelector((state) => state.localtour.pickdate);
  console.log("lsel", selectedDate);
  //const mode = useSelector((state) => state.localtour.mode);

  const PickupPlaceid = useSelector((state) => state.localtour.PickupZoneid);
  ...
  useEffect(() => {
    ...
    //   }
    // }
  }, [adults, children, seatingCapacity, entryytime]); // Dependencies
  ...
  const handlesubmit0 = () => {
    ...
    dispatch(setbookingType("travelpointzone"));
      ...
      <div className="col-12">
        <div className="searchMenu-date px-20 py-10 border-light rounded-4 -right js-form-dd js-calendar">
          <div>
            ...
            <Pickuptimezone entryytime={entryytime} isStatic={true} />
          </div>
        </div>
      </div>
