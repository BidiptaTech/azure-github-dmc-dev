...
import PriceMode from "./PriceMode2";
...
const Index3 = () => {
  ...
  const DropoffPlaceid = useSelector((state) => state.localtour.DropoffPlaceid);
  ...
  const handlesubmit0 = () => {
    ...
    dispatch(setbookingType("travelpoint"));
      ...
      <div className="col-12">
        <div className="searchMenu-date px-20 py-10 border-light rounded-4 -right js-form-dd js-calendar">
          <div>
            ...
            <Pickuptime entryytime={entryytime} isStatic={true} />
          </div>
        </div>
      </div>
