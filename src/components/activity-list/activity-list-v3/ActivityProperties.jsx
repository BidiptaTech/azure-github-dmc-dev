        ...
        >
          <div className="MuiBox-root css-t4lhjn">
            <div className="MuiBox-root css-d0j5jx">
              <img
                src="/icons/travel.png" // Using travel.png from the icons folder
                alt="Travel Icon"
            ...
            <h5 className="MuiTypography-root MuiTypography-h5 css-hu3rhi-MuiTypography-root">
              Please Give Pick Up, Drop Off Location and Date for Local Sideseen
              Search...
            </h5>
          </div>
        </div>
...
export default ActivityProperties1;
