                ...
                <table class="datatables-basic table table-bordered table-premium" id="packagedAttractionsTable">
                    <thead>
                        <tr>
                            ...
                            <th class="th-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Country">Country</th>
                    ...
                    <tbody>
                        @foreach($packagedAttractions as $key => $attraction)
                            <tr>
                                ...
                                <td>{{ $attraction->list_country ?? '—' }}</td>
                                <td>{{ $attraction->list_city ?? '—' }}</td>
...
<script>
    $(document).ready(function() {
        ...
        var packagedTableEl = $('.datatables-basic');
        var packagedInfiniteLoading = false;

        var packagedTable = packagedTableEl.DataTable({
            responsive: false,
            autoWidth: false,
        ...
        function loadMorePackagedIfNeeded() {
            ...
            setTimeout(function() {
                ...
                var nextLen = Math.min(currentInfo.length + packagedBatchSize, currentInfo.recordsDisplay);
                packagedTable.page.len(nextLen).draw(false);
                updatePackagedInfiniteFooter();
            }, 150);
        }
