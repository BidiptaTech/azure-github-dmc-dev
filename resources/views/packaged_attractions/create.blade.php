                        ...
                        <table class="table table-bordered table-sm package-price-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm package-price-input package-cost-input" id="child_cost_price" name="child_cost_price" data-sell-target="child_price" placeholder="0.00" value="{{ old('child_cost_price') }}" required>
                                        @error('child_cost_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                    </td>
                                    <td>
                                        <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm package-price-input package-sell-input" id="child_price" name="child_price" placeholder="0.00" value="{{ old('child_price') }}" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm package-price-input package-cost-input" id="adult_cost_price" name="adult_cost_price" data-sell-target="adult_price" placeholder="0.00" value="{{ old('adult_cost_price') }}" required>
                                        @error('adult_cost_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                    </td>
                                    <td>
                                        <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm package-price-input package-sell-input" id="adult_price" name="adult_price" placeholder="0.00" value="{{ old('adult_price') }}" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm package-price-input package-cost-input" id="senior_citizen_cost_price" name="senior_citizen_cost_price" data-sell-target="senior_citizen_price" placeholder="0.00" value="{{ old('senior_citizen_cost_price') }}" required>
                                        @error('senior_citizen_cost_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                    </td>
                                    <td>
                                        <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm package-price-input package-sell-input" id="senior_citizen_price" name="senior_citizen_price" placeholder="0.00" value="{{ old('senior_citizen_price') }}" required>
