...
@section('title', 'Booking Confirmation Mail')
    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="booking-message">
                <p>We're excited to confirm your booking! Everything is set and ready for your amazing experience. Here are all the details you need to know.</p>
            </div>
