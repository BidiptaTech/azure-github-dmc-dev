        ...
        <div class="row">
            ...
            <script>
                ...
                function populateCitiesDropdown(cities) {
                    ...
                    console.log(`Successfully populated ${cities.length} cities in dropdown`);
                }
                    ...
                    hourlyFields.forEach(field => {
                        if (field.value) {
                            ...
                            if (nameMatch) {
                                ...
                                const selectedHours = document.querySelector(`input[name="day${day}_${section}${fieldSuffix}_selected_hours"]`);
                    ...
                    localTransferFields.forEach(field => {
                        if (field.value) {
                            ...
                            if (nameMatch) {
                                ...
                                const vehicleSelect = document.querySelector(`select[name="day${day}_${section}${fieldSuffix}_vehicle_id"]`);
                                const serviceTypeSelect = document.querySelector(`select[name="day${day}_${section}${fieldSuffix}_service_type"]`);
                                const timeSelect = document.querySelector(`select[name="day${day}_${section}${fieldSuffix}_pickup_time"], select[name="day${day}_${section}${fieldSuffix}_time"]`);
                                const dateInput = document.querySelector(`input[name="day${day}_${section}${fieldSuffix}_date"], input[name="day${day}_${section}${fieldSuffix}_pickup_date"]`);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateDailyServices() {
        ...
        for (let dayIndex = 0; dayIndex < daysToShow.length; dayIndex++) {
                              ...
                              <div class="card-body bg-white">
                                 ...
                                 <div class="row mt-4" id="day${day}_entry_vehicle_results" style="display: none;">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!-- Submit Button for Entry Port -->
                                        <div class="col-12 mt-3">
                                            <div class="d-grid">
                                                <button type="button" class="btn btn-primary" onclick="saveService(${day}, 'entry_port')" id="day${day}_entry_submit_btn">
                                                    <i class="ri-save-line me-2"></i>Book Entry Port Service
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                 ...
                                 <div class="row g-4 align-items-end">
                                     <div class="col-md-3">
                                         <div class="form-group">
                                             ...
                                             <div class="position-relative">
                                                 <select class="form-select pickup-zone-select border-2" name="day${day}_exit_pickup_zone_id" style="padding-left: 45px;" id="exit_pickup_location_select">
                                     ...
                                     <div class="col-md-3">
                                         <div class="form-group">
                                             ...
                                             <div class="position-relative">
                                                 <select class="form-select dropoff-zone-select border-2" name="day${day}_exit_dropoff_zone_id" disabled style="padding-left: 45px; padding-right: 45px;" id="exit_dropoff_port_select">
         ...
         // After HTML is rendered, populate entry pickup and dropoff fields based on zone_on
         populateEntryPortFields();
...
function populateEntryPortFields() {
    console.log('Populating entry pickup and dropoff fields based on zone_on value...');
