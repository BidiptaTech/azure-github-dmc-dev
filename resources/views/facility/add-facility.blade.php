...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <form action="{{ route('facility.store') }}" method="POST" enctype="multipart/form-data" class="card-body">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" placeholder="Enter Facility Name"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="chargeable" class="form-control" id="chargeable" required
                                onchange="toggleCommentField()">
                    ...
                    <div class="col-md-6" id="comment_section" style="display: none;">
                        <div class="mb-3">
                            ...
                            <input type="text" name="comment" id="comment" placeholder="Enter Comment Name"
                                class="form-control" value="{{ old('comment', $facility->comment ?? '') }}">
                        </div>
                    </div>
                ...
                <div class="form-check form-switch">
                    ...
                    <input class="form-check-input" name="facility_status" type="checkbox" id="facility_status"
                        value="1">
