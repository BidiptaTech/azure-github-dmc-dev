...
<script src="{{ subdirectory_asset('assets/vendor/js/bootstrap.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/libs/node-waves/node-waves.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/libs/hammer/hammer.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/libs/i18n/i18n.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/libs/typeahead-js/typeahead.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/js/menu.js') }}"></script>
...
<!-- Vendors JS -->
<script src="{{ subdirectory_asset('assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>
<script src="{{ subdirectory_asset('assets/vendor/libs/swiper/swiper.js') }}"></script>

<!-- Main JS -->
<script src="{{ subdirectory_asset('assets/js/main.js') }}"></script>

<!-- Page JS -->
<script src="{{ subdirectory_asset('assets/js/dashboards-crm.js') }}"></script>
