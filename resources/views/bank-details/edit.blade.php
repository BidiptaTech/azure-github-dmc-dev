    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="page-header">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h2 class="mb-2"><i class="ri-bank-line me-2"></i>Edit Bank Details</h2>
                    <p class="mb-0 opacity-90">Update bank details, payment terms, and terms & conditions</p>
                </div>
        ...
        <form action="{{ route('bank-details.update', Crypt::encrypt($bankDetail->bank_detail_id)) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea name="terms_and_conditions" id="terms_and_conditions" rows="5" 
                                  class="form-control" placeholder="Enter terms and conditions...">{{ old('terms_and_conditions', $bankDetail->terms_and_conditions) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card modern-card mb-4">
                ...
                <div class="card-body">
                    <div id="payment-terms-container">
                        @php
                            $paymentTerms = old('payment_terms', $bankDetail->payment_terms ?? []);
                            ...
                            <div class="payment-term-row">
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-danger remove-term" onclick="removePaymentTerm(this)" 
                                            style="{{ count($paymentTerms) > 1 ? '' : 'display: none;' }}">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="bank_address" id="bank_address" rows="3" 
                                  class="form-control @error('bank_address') is-invalid @enderror" required>{{ old('bank_address', $bankDetail->bank_address) }}</textarea>
                        @error('bank_address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="bank_type" id="bank_type"
                                   ...
                                   value="{{ old('bank_type', $bankDetail->bank_type ?? 'SGD Accounts') }}">
                            @error('bank_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="swift_bic_iban" id="swift_bic_iban" 
                                   ...
                                   value="{{ old('swift_bic_iban', $bankDetail->swift_bic_iban) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="branch_code" id="branch_code" 
                                   ...
                                   value="{{ old('branch_code', $bankDetail->branch_code) }}">
                            @error('branch_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="aba_routing" id="aba_routing" 
                               ...
                               value="{{ old('aba_routing', $bankDetail->aba_routing) }}">
                        @error('aba_routing')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" 
                                   value="1" {{ old('is_active', $bankDetail->is_active) ? 'checked' : '' }}>
            ...
            @php
                $indiaBank = $bankDetail->india_bank_details ?? [];
            @endphp

            <!-- India / Second Bank Details Section (stored as JSON) -->
            <div class="card modern-card mb-4">
                <div class="section-header">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="india_gst_number" class="form-control"
                                   value="{{ old('india_gst_number', $indiaBank['gst_number'] ?? '') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">PAN Number</label>
                            <input type="text" name="india_pan_number" class="form-control"
                                   value="{{ old('india_pan_number', $indiaBank['pan_number'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="india_account_name" class="form-control"
                                   value="{{ old('india_account_name', $indiaBank['account_name'] ?? '') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Account Number</label>
                            <input type="text" name="india_account_number" class="form-control"
                                   value="{{ old('india_account_number', $indiaBank['account_number'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="india_bank_name" class="form-control"
                                   value="{{ old('india_bank_name', $indiaBank['bank_name'] ?? '') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">IFSC Code</label>
                            <input type="text" name="india_ifsc" class="form-control"
                                   value="{{ old('india_ifsc', $indiaBank['ifsc'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="india_bank_address" rows="3"
                                  class="form-control">{{ old('india_bank_address', $indiaBank['bank_address'] ?? '') }}</textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="india_bank_type" class="form-control"
                                   value="{{ old('india_bank_type', $indiaBank['bank_type'] ?? 'INR Accounts') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary btn-modern">
                    <i class="ri-save-line me-2"></i>Update Bank Details
                </button>
            </div>
        </form>
    </div>
