...
@section('title', 'Edit Quotation Settings')
@section('content')
<link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-lite.min.css" rel="stylesheet">
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            <h5 class="card-header">Edit Quotation Settings</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('quotation_settings.update_route', ['id' => $encryptedId]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('quotation_settings.pdf') }}" class="btn btn-secondary">Back</a>
                    </div>
                </form>
            </div>
        </div>
