...
<script>
    $(document).ready(function() {
        ...
        function generateVoucherSilently(restaurantData, bookingData, button, originalContent) {
            ...
            // Create HTML directly without server-side generation
            const voucherHtml = generateVoucherHtml(restaurantData, bookingData);
            
            // Capture the voucher using html2canvas
            captureVoucherFromHtml(voucherHtml, bookingData, button, originalContent);
        }

        // Function to generate voucher HTML directly in the browser
        function generateVoucherHtml(restaurantData, bookingData) {
            // Generate a coupon code
            const couponCode = bookingData.bookingId + '-' + new Date().toISOString().slice(0,10).replace(/-/g,'');
            
            // Format date for display
            const formattedDate = bookingData.checkInDate || 'N/A';
            const generatedDate = new Date().toISOString().replace('T', ' ').substr(0, 19);
            ...
            <head>
                <meta charset="utf-8">
                <title>Restaurant Coupon - ${bookingData.displayId}</title>
                <style>
                    * {
                        margin: 0;
                        padding: 0;
                        ...
                        <div class="voucher-body">
                            <div class="info-grid">
                                <div class="restaurant-info">
                                    ...
                                    <div class="info-content">
                                        ${restaurantData.restaurantName || 'International Cuisine'}
                                    </div>
                                </div>
                                ...
                                <div class="customer-info">
                                    ...
                                    <div class="info-content">
                                        ${restaurantData.fullName || 'Guest'}<br>
                                        📧 ${restaurantData.email || 'N/A'}<br>
                                ...
                                <div class="meals-info">
                                    ...
                                    <div class="info-content">
                                        Meal Type: ${(restaurantData.mealSpecificType && restaurantData.mealSpecificType.specificMealType) || 'N/A'}<br>
                                        Meal Session: ${restaurantData.mealType || 'N/A'}<br>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="booking-details">
                                <div class="detail-card">
                                    ...
                                    <div class="detail-value">${bookingData.displayId}</div>
                                </div>
                                <div class="detail-card">
                                ...
                                <div class="detail-card">
                                    ...
                                    <div class="detail-value">${restaurantData.visitTime || 'TBD'}</div>
                                </div>
                                <div class="detail-card">
                                    <div class="detail-label">Guests</div>
                                    <div class="detail-value">${restaurantData.adultCount || 0} Adults + ${restaurantData.childCount || 0} Children</div>
                                </div>
                            </div>
                        </div>
                        
                        <div class="voucher-footer">
                            <div class="coupon-code">COUPON CODE: ${couponCode}</div>
                            <div class="validity">
                                Valid for: ${formattedDate} | ${bookingData.dmcCompany || 'Your Vacation Singapore Pte Ltd'}<br>
                                Please present this coupon at the restaurant | Generated on ${generatedDate}
                            </div>
                        </div>
                    </div>
                </div>
