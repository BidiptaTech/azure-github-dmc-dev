...
@section('title', 'Itinerary Settings')
@section('content')
<link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-lite.min.css" rel="stylesheet">
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            <h5 class="card-header">Itinerary Settings</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('itinerary_settings.save') }}" method="POST">
                    @csrf
                ...
                <h6 class="mb-3">Saved Itinerary Infos</h6>
                        ...
                        <tbody>
                            @forelse(($allSettings ?? []) as $s)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a class="btn btn-sm btn-primary" href="{{ route('itinerary_settings.edit', ['id' => \Illuminate\Support\Facades\Crypt::encryptString((string) $s->itinerary_setting_id)]) }}">Edit</a>
                                            <form action="{{ route('itinerary_settings.delete', ['id' => \Illuminate\Support\Facades\Crypt::encryptString((string) $s->itinerary_setting_id)]) }}" method="POST" onsubmit="return confirm('Delete this itinerary info?');">
                                                @csrf
                                                @method('DELETE')
