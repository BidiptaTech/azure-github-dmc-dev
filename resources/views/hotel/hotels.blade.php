...
<script>
    $(document).ready(function() {
        ...
        var hotelsTable = $('.datatables-basic').DataTable({
            responsive: false,
            autoWidth: false,
        ...
        function loadMoreHotelsIfNeeded() {
            ...
            setTimeout(function() {
                ...
                hotelsTable.page.len(Math.min(currentInfo.length + hotelsBatchSize, currentInfo.recordsDisplay)).draw(false);
                updateHotelsInfiniteFooter();
            }, 150);
        }
        ...
        hotelsTable.on('draw.dt', function() {
            if (!hotelsInfiniteGuard) updateHotelsInfiniteFooter();
        });
