            ...
            <div class="card-datatable table-responsive pt-0">
                <div class="d-flex justify-content-between align-items-center" style="margin: 15px;">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0">Hotel Approval</h5>
                    </div>
                ...
                <table class="datatables-basic table table-bordered">
                    ...
                    <tbody>
                        @foreach($pendinghotels as $key => $pendinghotel)
                        <tr>
                            <td>{{ ++$key }}</td>
                            <td class="category-name">{{ $pendinghotel->name }}</td>
                            @php
                                $roleId = auth()->user()->role_id;
                            @endphp
                            ...
                            @if($roleId == 10)
                                @php
                                    $dmcUser = App\Models\User::where('userId', $pendinghotel->dmc_id)->first();
                                @endphp
                            ...
                            @endif
                            <td>
                                <img src="{{ $pendinghotel->main_image }}" alt="Hotel Image" style="width: 50px; height: 50px;">
                            </td>
                            ...
                            <td style="display: inline-block; white-space: nowrap;">
                                ...
                                <a href="{{ route('hotels.edit.approval', $pendinghotel->hotel_unique_id) }}"
                                ...
                                <button type="button"
                                    ...
                                    onclick="setDeleteForm('{{ route('hotels.destroy', $pendinghotel->hotel_unique_id) }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960"
                                        width="16px" fill="#ffffff">
                                        <path
