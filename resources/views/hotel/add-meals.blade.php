...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-6">
            ...
            <form id="restaurantForm" method="POST" action="{{ route('hotel-meals-store') }}" enctype="multipart/form-data" class="card-body js-submit-loader-form" data-loader-message="Saving meal...">
                @csrf
                <!-- Hidden Fields -->
                <fieldset>
                            ...
                            @foreach($meals as $key => $meal)
                                ...
                                <td>
                                    ...
                                    <td style="display: inline-block; white-space: nowrap;">
                                        ...
                                        <a href="{{ route('hotel-meal-edit', $meal->meal_id) }}" 
                                        ...
                                        <button type="button" 
                                                ...
                                                onclick="setDeleteForm('{{ route('hotel-meal-destroy', $meal->meal_id) }}')">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="#ffffff">
