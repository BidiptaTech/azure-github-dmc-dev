...
<script>
    $(document).ready(function() {
        ...
        var driversTableEl = $('.datatables-basic');
        var driversInfiniteLoading = false;

        var driversTable = driversTableEl.DataTable({
            responsive: false,
            autoWidth: false,
        ...
        function loadMoreDriversIfNeeded() {
            ...
            setTimeout(function() {
                ...
                var nextLen = Math.min(currentInfo.length + driversBatchSize, currentInfo.recordsDisplay);
                driversTable.page.len(nextLen).draw(false);
                updateDriversInfiniteFooter();
            }, 150);
        }
