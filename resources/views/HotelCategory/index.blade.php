            ...
            <div class="card-datatable table-responsive pt-0">
                <div class="d-flex justify-content-between align-items-center" style="margin: 15px;">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0">Hotel Category Listing</h5>
                    </div>

                    <div class="d-flex justify-content-between gap-3">
                        <!-- Add New Category Button -->
                        <a href="{{ route('hotel-category.create') }}" class="btn btn-primary btn-sm d-flex align-items-center gap-2">
                            <i class="fas fa-plus"></i> Add New Hotel Category
                        </a>
                ...
                <table class="datatables-basic table table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach($hotel_categories as $key => $category)
                        <tr>
                            <td>{{ ++$key }}</td>
                            <td class="category-name">{{ $category->name }}</td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <i class="{{ $category->icon }} me-2" style="font-size: 24px;"></i>
                            ...
                            <td class="gap-2">
                                <!-- Edit Button -->
                                <a href="{{ route('hotel-category.edit', $category->id) }}"
                                ...
                                <button type="button" class="btn btn-danger btn-sm rounded-circle"
                                    ...
                                    onclick="setDeleteForm('{{ route('hotel-category.destroy', $category->category_id) }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px"
                                        fill="#ffffff">
                                        <path
