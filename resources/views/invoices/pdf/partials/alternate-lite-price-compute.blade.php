{{--
  Variables for invoices.pdf.alternate when mode=price-only (lite layout).
  Mirrors proforma-price-only / final-price-only Price Summary math (PRO transfer corrections, negotiated, tax, payments).
--}}
@php
    ...
    $liteActualAmount = ($isPro && $correctedTotalAmount !== null)
