            ...
            success: function(response) {
                ...
                if (response.success) {
                    Swal.fire({
                        ...
                        const modal = document.getElementById(`paymentHistoryModal${tourId}`);
                        if (modal) {
                            ...
                            if (typeof $ !== 'undefined') {
                                $(`#paymentHistoryModal${tourId}`).modal('hide');
                            }
                        }
...
function filterTable() {
    ...
    rows.forEach(row => {
        ...
        // Updated column indices with Payment Status column added
