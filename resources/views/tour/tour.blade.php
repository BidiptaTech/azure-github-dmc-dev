...
<script src="{{ asset('js/booking-approval.js') }}"></script>
                        ...
                        @if(count($tours) > 0)
                            ...
                            <tr data-tour-id="{{ $tour->tour_id }}">  <!-- Tour ID added here -->
                                ...
                                <td class="category-name">
                                    {{ \App\Helpers\CommonHelper::DateFormatAdmin($tour->check_in_time) }} - {{ \App\Helpers\CommonHelper::DateFormatAdmin($tour->check_out_time) }}</td>
                                    ...
                                    <td>
                                                                        ...
                                                                        @foreach ($tourAttractions as $key => $order)
                                                                            @foreach ($order['attraction_details'] as $attraction)
                                                                                <tr>
                                                                                    ...
                                                                                    <!-- Booking Date -->
                                                                                    <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($attraction['bookingDate'] ?? 'N/A') }}</td>
                                        ...
                                        <div class="modal fade" id="guideModal{{ $tour->tour_id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-xl">
                                                ...
                                                <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($tour_guide['bookingDate'] ?? 'N/A') }}</td>
                                                <td>{{ ($tour_guide['adults'] ?? 0) + ($tour_guide['children'] ?? 0) }}</td>
                                                <td>{{ $tour_guide['entrypickup'] ?? 'N/A' }}</td>
                                                <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($tour_guide['pickupdate'] ?? 'N/A') }}</td>
                                                                        ...
                                                                        @foreach ($tourTravels as $order)
                                                                            @foreach ($order['travel_details'] as $travel)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($travel['bookingDate'] ?? 'N/A') }}</td>
                                                                        ...
                                                                        @foreach ($tourRestaurants as $order)
                                                                            @foreach ($order['restaurant_details'] as $restaurant)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($restaurant['bookingDate'] ?? 'N/A') }}</td>
                                                                        ...
                                                                        @foreach ($tourPickUps as $order)
                                                                            @foreach ($order['entrypickup_details'] as $pickup)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($pickup['bookingDate'] ?? 'N/A') }}</td>
                                                                                    <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($pickup['pickupdate'] ?? 'N/A') }}</td>
                                                                        ...
                                                                        @foreach ($tourDropOffs as $order)
                                                                            @foreach ($order['exitdropoff_details'] as $dropoff)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($dropoff['bookingDate'] ?? 'N/A') }}</td>
                                                                                    <td>{{ \App\Helpers\CommonHelper::DateFormatAdmin($dropoff['exitpickupdate'] ?? 'N/A') }}</td>
                ...
                <form id="paymentForm{{ $tour->tour_id }}" action="{{ route('tour.add-payment', $tour->tour_id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="amount{{ $tour->tour_id }}" class="form-label fw-bold">
                                <i class="fas fa-dollar-sign text-success me-2"></i>Due Amount
                        </label>
