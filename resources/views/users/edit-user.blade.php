            ...
            <form action="{{ route('users.update', $users->userId) }}" method="POST" enctype="multipart/form-data" class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="email" name="email" value="{{ $users->email }}" required oninput="validateEmail(this)">
...
<script>
    ...
    // Role change handler
    $('#inputRoleselect').on('change', updateFields);
    ...
    function updateFields() {
        const userRole = parseInt($('#inputRoleselect').val());
        const containers = {
