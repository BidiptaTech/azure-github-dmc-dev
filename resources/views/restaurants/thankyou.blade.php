...
<div class="thankyou-container">
    <div class="thankyou-card">
        <div class="card-content">
            ...
            <p class="message">Your restaurant submission has been received</p>
            ...
            <div class="notification-preview">
                ...
                <div class="notification-text">
                    ...
                    <p class="notification-message">You'll receive a notification when your restaurant is approved</p>
                </div>
            </div>
            
            <!-- Action Button -->
            <a href="{{ route('restaurant.index') }}" class="action-button">
                Back to Restaurants <i class="fas fa-arrow-right"></i>
            </a>
        </div>
...
<style>
    ...
    .thankyou-card:hover {
        ...
        box-shadow: 0 30px 70px rgba(240, 95, 22, 0.15);
    }
