...
<script>
    $(document).ready(function() {
        ...
        var restaurantsTableEl = $('.datatables-basic');
        var restaurantsInfiniteLoading = false;

        var restaurantsTable = restaurantsTableEl.DataTable({
            responsive: false,
            autoWidth: false,
        ...
        function loadMoreRestaurantsIfNeeded() {
            ...
            setTimeout(function() {
                ...
                var nextLen = Math.min(currentInfo.length + restaurantsBatchSize, currentInfo.recordsDisplay);
                restaurantsTable.page.len(nextLen).draw(false);
                updateRestaurantsInfiniteFooter();
            }, 150);
        }
