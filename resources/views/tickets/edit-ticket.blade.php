                                            ...
                                            <table class="table table-bordered table-sm ticket-price-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-cost-input" id="child_cost_price" name="child_cost_price" data-sell-target="child_price" placeholder="0.00" value="{{ old('child_cost_price', $ticket->child_cost_price) }}">
                                                            @error('child_cost_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-sell-input" id="child_price" name="child_price" placeholder="0.00" value="{{ old('child_price', $ticket->child_price) }}">
                                                            @error('child_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-cost-input" id="child_cost_price_nri" name="child_cost_price_nri" data-sell-target="child_price_nri" placeholder="0.00" value="{{ old('child_cost_price_nri', $ticket->child_cost_price_nri) }}" required>
                                                            @error('child_cost_price_nri')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-sell-input" id="child_price_nri" name="child_price_nri" placeholder="0.00" value="{{ old('child_price_nri', $ticket->child_price_nri) }}" required>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-cost-input" id="adult_cost_price" name="adult_cost_price" data-sell-target="adult_price" placeholder="0.00" value="{{ old('adult_cost_price', $ticket->adult_cost_price) }}">
                                                            @error('adult_cost_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-sell-input" id="adult_price" name="adult_price" placeholder="0.00" value="{{ old('adult_price', $ticket->adult_price) }}" required>
                                                            @error('adult_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-cost-input" id="adult_cost_price_nri" name="adult_cost_price_nri" data-sell-target="adult_price_nri" placeholder="0.00" value="{{ old('adult_cost_price_nri', $ticket->adult_cost_price_nri) }}" required>
                                                            @error('adult_cost_price_nri')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-sell-input" id="adult_price_nri" name="adult_price_nri" placeholder="0.00" value="{{ old('adult_price_nri', $ticket->adult_price_nri) }}" required>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-cost-input" id="senior_adult_cost_price" name="senior_adult_cost_price" data-sell-target="senior_adult_price" placeholder="0.00" value="{{ old('senior_adult_cost_price', $ticket->senior_adult_cost_price) }}">
                                                            @error('senior_adult_cost_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-sell-input" id="senior_adult_price" name="senior_adult_price" placeholder="0.00" value="{{ old('senior_adult_price', $ticket->senior_adult_price) }}">
                                                            @error('senior_adult_price')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-cost-input" id="senior_adult_cost_price_nri" name="senior_adult_cost_price_nri" data-sell-target="senior_adult_price_nri" placeholder="0.00" value="{{ old('senior_adult_cost_price_nri', $ticket->senior_adult_cost_price_nri) }}" required>
                                                            @error('senior_adult_cost_price_nri')<div class="text-danger small">{{ $message }}</div>@enderror
                                                        </td>
                                                        <td>
                                                            <input type="number" step="0.01" min="0" inputmode="decimal" class="form-control form-control-sm ticket-price-input ticket-sell-input" id="senior_adult_price_nri" name="senior_adult_price_nri" placeholder="0.00" value="{{ old('senior_adult_price_nri', $ticket->senior_adult_price_nri) }}" required>
