                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                     ...
                                     <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="child_price" name="child_price" value="{{ old('child_price', $ticket->child_price) }}">
                                        @error('child_price')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="child_cost_price" name="child_cost_price" value="{{ old('child_cost_price', $ticket->child_cost_price) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="adult_price" name="adult_price" value="{{ old('adult_price', $ticket->adult_price) }}" required>
                                        @error('adult_price')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="adult_cost_price" name="adult_cost_price" value="{{ old('adult_cost_price', $ticket->adult_cost_price) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="senior_adult_price" name="senior_adult_price" value="{{ old('senior_adult_price', $ticket->senior_adult_price) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="senior_adult_cost_price" name="senior_adult_cost_price" value="{{ old('senior_adult_cost_price', $ticket->senior_adult_cost_price) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="child_price_nri" name="child_price_nri" placeholder="Enter Child Sell Price" value="{{ old('child_price_nri', $ticket->child_price_nri) }}" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="child_cost_price_nri" name="child_cost_price_nri" placeholder="Enter Child Cost Price" value="{{ old('child_cost_price_nri', $ticket->child_cost_price_nri) }}" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="adult_price_nri" name="adult_price_nri" placeholder="Enter Adult Sell Price" value="{{ old('adult_price_nri', $ticket->adult_price_nri) }}" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="adult_cost_price_nri" name="adult_cost_price_nri" placeholder="Enter Adult Cost Price" value="{{ old('adult_cost_price_nri', $ticket->adult_cost_price_nri) }}" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="senior_adult_price_nri" name="senior_adult_price_nri" placeholder="Enter Senior Sell Price" value="{{ old('senior_adult_price_nri', $ticket->senior_adult_price_nri) }}" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="1" class="form-control" id="senior_adult_cost_price_nri" name="senior_adult_cost_price_nri" placeholder="Enter Senior Cost Price" value="{{ old('senior_adult_cost_price_nri', $ticket->senior_adult_cost_price_nri) }}" required>
