...
<style>
    ...
    /* Column widths */
    #guidesTable { table-layout: fixed; width: 100%; }
    #guidesTable .col-no         { width: 38px;  min-width: 38px; }
    ...
    #guidesTable .col-status     { width: 78px;  min-width: 70px; }
    #guidesTable .col-action     { width: 135px; min-width: 135px; }
    #guidesTable .col-created-at { width: 90px;  min-width: 85px;  font-size: 10.5px; }

    /* Wrap name and email */
    #guidesTable td.col-name,
    #guidesTable td.col-email {
        white-space: normal;
        word-break: break-word;
        overflow-wrap: break-word;
    }

    /* Icons — always horizontal, no wrapping */
    #guidesTable td.col-action .action-wrap {
        display: flex;
        flex-wrap: nowrap;
        gap: 3px;
        align-items: center;
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                ...
                <div class="page-header">
                    <div>
                        <h5 class="page-title">Tour Guides</h5>
                        <p class="page-subtitle">Manage tour guides, contact details, languages, and status</p>
                    </div>
                    <div class="toolbar-actions">
                        @if(hasPermission('create guide'))
                        <a href="{{ route('guide.create') }}" class="btn btn-primary btn-premium">
                ...
                <table class="datatables-basic table table-bordered table-premium" id="guidesTable">
                    <thead>
                        <tr>
                            <th class="th-tooltip col-no" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Serial Number">No</th>
                            <th class="th-tooltip col-name" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Guide Name">Name</th>
                            @php
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-name">
                                <span class="fw-semibold">{{ $guide->name }}</span>
                            </td>
                            ...
                            @endphp
                            @if($roleId == 10)
                                @php $dmcUser = App\Models\User::where('userId', $guide->dmc_id)->first(); @endphp
                            ...
                            @if(hasPermission('edit guide') || hasPermission('delete guide'))
                                ...
                                <td class="col-action">
                                    ...
                                    <a href="{{ route('guide.edit', Crypt::encrypt($guide->guide_id)) }}"
                                       ...
                                       data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit Guide">
                                    ...
                                    <button type="button"
                                            ...
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete Guide"
...
<script>
    $(document).ready(function() {
        ...
        var guidesTableEl = $('.datatables-basic');
        var guidesInfiniteLoading = false;

        var guidesTable = guidesTableEl.DataTable({
            responsive: false,
            autoWidth: false,
            ordering: false,
            ...
            columnDefs: [
                ...
                { targets: '.col-action',      width: '135px' },
        ...
        function loadMoreGuidesIfNeeded() {
            ...
            setTimeout(function() {
                ...
                var nextLen = Math.min(currentInfo.length + guidesBatchSize, currentInfo.recordsDisplay);
                guidesTable.page.len(nextLen).draw(false);
                updateGuidesInfiniteFooter();
            }, 150);
        }
...
<script>
    // Bootstrap tooltips for all th-tooltip elements (headers + action buttons)
    function initGuideTooltips() {
        if (typeof bootstrap === 'undefined' || !bootstrap.Tooltip) return;
        document.querySelectorAll('#guidesTable .th-tooltip[data-bs-toggle="tooltip"]').forEach(function(el) {
    ...
    $(document).ready(function() {
        initGuideTooltips();
        $('#guidesTable').on('draw.dt', function() { initGuideTooltips(); });
    });

    // Guide deletion with SweetAlert2
