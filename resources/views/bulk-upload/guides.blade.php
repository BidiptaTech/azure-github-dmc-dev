            ...
            <div class="col-xl-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-gradient-primary text-white border-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0 text-white">
                                <i class="ri-user-star-line me-2"></i>Guide Bulk Upload
                        </h5>
                            <div class="d-flex gap-2">
                                <a href="{{ route('bulk-upload.guides.template') }}" class="btn btn-light btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info border-0 mb-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <ul class="mb-0 small">
                                        <li><strong>Required Fields:</strong> Salutation, Gender, Name, Email, Phone, Address, Country, City</li>
                                        <li><strong>Email Validation:</strong> Must be unique - no duplicate emails allowed</li>
                                        <li><strong>Country Restriction:</strong> You can only upload guides for your country: <strong>{{ Auth::user()->country ?? 'Please set your country' }}</strong></li>
                                        <li><strong>City Validation:</strong> City must exist in our database for your country</li>
                                        <li><strong>Language Validation:</strong> Only languages available in our system are accepted</li>
                                        <li><strong>Proficiency Levels:</strong> Beginner, Intermediate, Fluent, Expert, Mother Tongue</li>
                                        <li><strong>Multiple Languages:</strong> Add new rows with only Language & Proficiency filled for additional languages</li>
                        ...
                        <form action="{{ route('bulk-upload.guides.upload') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="submit" class="btn btn-primary px-4" id="uploadBtn" disabled>
                                    <i class="ri-upload-line me-1"></i>Upload Guides
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body p-0">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted mb-0">Your recent guide uploads will appear here</p>
                            </div>
                        @endif
                    </div>
                </div>
