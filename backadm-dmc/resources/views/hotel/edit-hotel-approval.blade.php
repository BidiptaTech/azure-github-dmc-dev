...
@section('title', 'Edit Hotel Approve')
@section('content')
                ...
                <div class="card">
                    <div class="card mb-6">
                        <h5 class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('hotels.approval') }}" class="btn btn-sm btn-outline-danger">
                                <i class="mdi mdi-arrow-left"></i> Back
                            </a>
                            @if($same_hotel)
                            <!-- Same Hotel popup Modal -->
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                Already Exist Same Hotel !
                            </button>
                            @endif
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        @if(session('existingHotel') && session('existingHotel')->name)
                            <div class="alert alert-warning">
                                A hotel with the same location already exists: {{ session('existingHotel')->name }}
                            </div>
                        @endif
                        <form id="hotelForm" method="POST"
                            action="{{ route('hotels.update.approval', $hotel->hotel_unique_id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    {{-- <span class="text-danger">(This hotel name cannot be changed.)</span> --}}
                                    @if($same_hotel)
                                    <input type="text" class="form-control" id="input35" name="name"
                                    value="{{ old('name', $same_hotel->name) }}" placeholder="Enter Hotel Name" readonly required>
                                    <span></span>
                                    @else
                                    <input type="text" class="form-control" id="input35" name="name"
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="input35"
                                        value="{{ old('name', $hotel->display_id) }}" disabled>
                                    @error('unique_id')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="hotel_ownership" id="ownership" class="form-control">
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="phone" class="form-label"><strong>General Phone No</strong><span
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="email" class="form-label"><strong>General Email</strong><span
                                            style="color: red; font-weight: bold;">*</span></label>
                                ...
                                {{-- <div class="mb-3 col-md-4">
                                    ...
                                    <input value="{{ old('city', $hotel->city) }}" type="text" class="form-control" id="city" name="city"
                                ...
                                {{-- <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="country" name="country"
                                        value="{{ old('country', $hotel->country) }}" placeholder="Enter Country"
                                        required>
                                    @error('country')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="pincode" name="pincode"
                                        value="{{ old('zipcode', $hotel->zipcode) }}" placeholder="Enter Zip Code"
                                        required>
                                    @error('pincode')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="latitude" name="latitude"
                                        value="{{ old('latitude', $hotel->latitude) }}" placeholder="Enter Latitude"
                                        required>
                                    @error('latitude')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="longitude" class="form-label"><strong>Longitude</strong><span
                                            style="color: red; font-weight: bold;">*</span></label>
                                    <input type="text" class="form-control" id="longitude" name="longitude"
                                        value="{{ old('longitude', $hotel->longitude) }}" placeholder="Enter Longitude"
                                        required>
                                    @error('longitude')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3 col-md-12">
                                    <div class="mb-3">
                                        <fieldset class="border p-1 position-relative row">
                                            <!-- <div class="mb-3 col-md-3">
                                                <label for="time_range" class="form-label"><strong>Check In Time</strong></label>
                                                <div class="input-group">
                                                    <input 
                                                    value="{{ old('check_in_time', $hotel->{'check_in_time'} ?? '') }}"
                                                    type="time" id="check_in_time" name="check_in_time" class="form-control"
                                            ...
                                            <div class="mb-3 col-md-3">
                                                <label for="time_range" class="form-label"><strong>Check Out Time</strong></label>
                                                <div class="input-group">
                                                    <input 
                                                    value="{{ old('check_out_time', $hotel->{'check_out_time'} ?? '') }}"
                                                    type="time" id="check_out_time" name="check_out_time" class="form-control"
                                                        placeholder="Enter start time (e.g., 09:00)">
                                                </div>
                                                @error('time_range')
                                                <div class="text-danger mt-1">{{ $message }}</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ $same_hotel->name }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="hotel-details">
                    <p><strong>Hotel Name:</strong> {{ $same_hotel->name }}</p>
                    <p><strong>Location:</strong> {{ $same_hotel->address }}</p>
                    <p><strong>Zip Code:</strong> {{ $same_hotel->zipcode }}</p>
                    <p><strong>Latitude:</strong> {{ $same_hotel->latitude }}</p>
                    <p><strong>Longitude:</strong> {{ $same_hotel->longitude }}</p>
                    <p><strong>City:</strong> {{ $same_hotel->city }}</p>
                    <p><strong>State:</strong> {{ $same_hotel->state }}</p>
                    <p><strong>Country:</strong> {{ $same_hotel->country }}</p>
                    <p><strong>Description:</strong> {{ strip_tags($same_hotel->description) ?? 'No description available' }}</p>

                    <!-- Optionally, you can display a hotel image -->
                    @if($same_hotel->image)
                        <img src="{{ asset('storage/'.$same_hotel->image) }}" alt="{{ $same_hotel->name }}" class="img-fluid rounded">
                    @endif
                </div>
            </div>
