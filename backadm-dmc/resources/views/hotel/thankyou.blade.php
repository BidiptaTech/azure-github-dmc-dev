...
<div class="thankyou-container">
    <div class="thankyou-card">
        <div class="card-content">
            ...
            <p class="message">Your hotel submission has been received</p>
            ...
            <div class="notification-preview">
                ...
                <div class="notification-text">
                    ...
                    <p class="notification-message">You'll receive a notification when your hotel is approved</p>
                </div>
            </div>

            <!-- Action Button -->
            <a href="{{ route('hotels.index') }}" class="action-button">
                Back to Hotels <i class="fas fa-arrow-right"></i>
            </a>
        </div>
...
<style>
    ...
    .thankyou-card:hover {
        ...
        box-shadow: 0 30px 70px rgba(22, 65, 240, 0.15);
    }
    ...
    .avatar {
        ...
        align-items: center;
        justify-content: center;
        background: linear-gradient(135deg, #0e5cad 0%, #7367f0 100%);
        border-radius: 50%;
        font-size: 3.5rem;
        z-index: 2;
    ...
    .avatar-ring {
        ...
        border-radius: 50%;
        border: 2px dashed rgba(14, 92, 173, 0.5);
    ...
    .title {
        ...
        background: linear-gradient(90deg, #0e5cad, #7367f0);
    ...
    .action-button {
        ...
        transition: all 0.3s ease;
        box-shadow: 0 10px 20px rgba(14, 92, 173, 0.3);
        margin-top: 1.5rem;
    }
    
    .action-button:hover {
        transform: translateY(-3px);
        box-shadow: 0 15px 25px rgba(14, 92, 173, 0.4);
        color: white;
    }
    ...
    .decoration {
        position: absolute;
        background: linear-gradient(135deg, rgba(14, 92, 173, 0.1), rgba(115, 103, 240, 0.1));
        border-radius: 50%;
    }
