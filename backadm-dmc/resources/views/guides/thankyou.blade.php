...
<div class="thankyou-container">
    <div class="thankyou-card">
        <div class="card-content">
            ...
            <p class="message">Your guide submission has been received</p>
            ...
            <div class="notification-preview">
                ...
                <div class="notification-text">
                    ...
                    <p class="notification-message">You'll receive a notification when your guide is approved</p>
                </div>
            </div>
            
            <!-- Action Button -->
            <a href="{{ route('guide.index') }}" class="action-button">
                Back to Guides <i class="fas fa-arrow-right"></i>
            </a>
        </div>
...
<style>
    ...
    .avatar-ring {
        ...
        border-radius: 50%;
        border: 2px dashed rgba(37, 117, 252, 0.5);
