            ...
            <form action="{{ route('cities.store') }}" method="POST" class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="country_name" class="form-label"><strong>Country Name</strong><span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cityName" name="city_name" readonly required>
                        @error('city_name')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
