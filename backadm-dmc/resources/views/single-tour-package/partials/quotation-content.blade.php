    @php
        ...
        // Dompdf sometimes cannot render the rupee glyph (â‚¹) with the default font,
        ...
        // = per-pax price (after FOC distribution) Ã— foc_size
        ...
        if (!empty($supplements) && is_array($supplements)) {
            foreach ($supplements as $s) {
                ...
                // from the main hotel inclusions panel â€” intentionally no suppHotelCounts logic.
    ...
    <div class="page">
        @php
            ...
            $formattedDisplayId = $ordPart !== '' ? $ordPart : 'â€”';
        ...
        <table class="quotation-main-table">
            ...
            {{-- Row 2: inclusions only â€” row height = tallest column --}}
                        ...
                        <ul class="inclusion-list">
                                                ...
                                                <div class="inclusion" style="margin: 2px 0 0 14px; line-height: 1.25;">
                                                    ...
                                                    @if(!empty($tr['pickup_location_name']) || !empty($tr['pickup_time']))
                                                        ...
                                                        @if(!empty($tr['pickup_time']))
                                                            @if(!empty($tr['pickup_location_name'])) â€” @endif
                                            ...
                                            @if(is_array($gd) && (
                                                ...
                                                <div class="inclusion" style="margin: 2px 0 0 14px; line-height: 1.25;">
                                                    ...
                                                    @if(!empty($gd['language']))
                                                        @if(!empty($gd['guide_name'])) Â· @endif
                                                        {{ $gd['language'] }}
                                                    @endif
                            ...
                            @if(!empty($bookedRestaurantCards))
                                @foreach($bookedRestaurantCards as $restCard)
                                    ...
                                    @endphp
                                    <li class="inclusion">
                                        <span class="bold">Restaurant:</span> {{ $restTitle }}@if(!empty($mealPlan)) â€” {{ $mealPlan }}@endif
                                        @if(is_array($rs))
            ...
            {{-- Row 3: pricing only â€” same row â‡’ same horizontal alignment in all PDF engines --}}
