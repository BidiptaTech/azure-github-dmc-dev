...
<style>
    ...
    /* Column widths */
    #vehiclesTable { table-layout: fixed; width: 100%; }
    #vehiclesTable .col-no          { width: 38px;  min-width: 38px; }
    #vehiclesTable .col-name        { width: 120px; min-width: 100px; }
    ...
    /* Action icons row */
    #vehiclesTable td.col-action .action-wrap {
        display: flex;
        flex-wrap: nowrap;
        gap: 3px;
        align-items: center;
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                ...
                <div class="page-header">
                    <div>
                        <h5 class="page-title">Vehicles</h5>
                ...
                <table class="datatables-basic table table-bordered table-premium" id="vehiclesTable">
                    <thead>
                        <tr>
                            <th class="th-tooltip col-no" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Serial Number">No</th>
                            <th class="th-tooltip col-name" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Vehicle Name">Vehicle Name</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-availability">
                                ...
                                @else
                                    <span class="badge-status inactive"><span class="dot"></span>Unavailable</span>
                                @endif
                            </td>
                            @if(hasPermission('edit vehicle') || hasPermission('delete vehicle'))
                            <td class="col-action">
                                <div class="action-wrap">
                                    ...
                                    <a href="{{ route('vehicle.edit', Crypt::encrypt($vehicle->vehicle_id)) }}"
                                       ...
                                       data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit Vehicle">
                                    ...
                                    <button type="button"
                                            ...
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete Vehicle"
    ...
    $(document).ready(function() {
        ...
        function loadMoreVehiclesIfNeeded() {
            ...
            setTimeout(function() {
                ...
                vehiclesTable.page.len(Math.min(currentInfo.length + vehiclesBatchSize, currentInfo.recordsDisplay)).draw(false);
                updateVehiclesInfiniteFooter();
            }, 150);
        }
        ...
        function bindVehiclesInfiniteScroll() {
            ...
            vehiclesTable.on('search.dt.vehiclesInfinite', function() {
                if (vehiclesInfiniteGuard) return;
            ...
            vehiclesTable.on('draw.dt.vehiclesInfinite', function() {
                if (!vehiclesInfiniteGuard) updateVehiclesInfiniteFooter();
            });
...
<script>
    function initVehicleTooltips() {
        ...
        document.querySelectorAll('#vehiclesTable .th-tooltip[data-bs-toggle="tooltip"]').forEach(function(el) {
