                ...
                <div id="vehicleDetailsContainer">
                    <div class="vehicle-form">
                        ...
                        @endif
                            ...
                            <fieldset id="privatePrice" class="border rounded mb-4 vehicle-rate-fieldset">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.01"
                                                                ...
                                                                placeholder="0.00" value="{{ old($rate['cost']) }}">
                                                        ...
                                                        <td>
                                                            <input type="number" step="0.01"
                                                                ...
                                                                placeholder="0.00" value="{{ old($rate['sell']) }}">
                                        ...
                                        <table class="table table-bordered table-sm vehicle-rate-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" step="0.01" class="form-control" id="cancellation_cost" name="cancellation_cost" placeholder="0.00" value="{{ old('cancellation_cost') }}">
                                                        @error('cancellation_cost')<div class="text-danger mt-1">{{ $message }}</div>@enderror
                                                    </td>
                                                    <td>
                                                        <input type="number" step="0.01" class="form-control" id="cancellation_sell" name="cancellation_sell" placeholder="0.00" value="{{ old('cancellation_sell') }}">
