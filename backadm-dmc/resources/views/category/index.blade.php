            ...
            <div class="card-datatable table-responsive pt-0">
                ...
                <div class="page-header">
                    <div>
                        ...
                        <p class="page-subtitle">Manage facility categories, icons, and status</p>
                    </div>
                    <div class="toolbar-actions">
                        @if(hasPermission('create category'))
                        <a href="{{ route('category.create') }}" class="btn btn-primary btn-premium">
                ...
                <table class="datatables-basic table table-bordered table-premium">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Logo</th>
                        ...
                        <tr>
                            ...
                            <td class="gap-2">
                                ...
                                <button type="button" class="btn btn-icon btn-icon-delete"
                                    ...
                                    onclick="deleteCategory('{{ route('category.destroy', $category->category_id) }}', '{{ addslashes($category->name) }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px"
                                        fill="#dc2626">
                                        <path
...
<!-- End DataTable JS -->
<script>
window.deleteCategory = function(deleteUrl, categoryName) {
    Swal.fire({
        title: 'Delete Category?',
