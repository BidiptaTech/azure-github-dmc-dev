...
@section('title', 'Guide Bulk Upload')
...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Guide Bulk Upload</h4>
                <p class="text-muted mb-0">Upload multiple guides at once using CSV file</p>
            </div>
        ...
        <div class="row">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <a href="{{ route('bulk-upload.guides.template') }}" class="btn btn-outline-primary btn-sm">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted small">Fill in your guide data according to the template format. Required fields are marked with *</p>
                        </div>
                        ...
                        <div class="alert alert-info">
                            <small>
                                ...
                                <ul class="mb-0 mt-1">
                                    ...
                                    <li>Languages should be comma-separated</li>
                                    <li>Ensure valid experience years</li>
            ...
            <div class="col-12 col-lg-8 mb-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ri-compass-3-line me-2"></i>Upload Guides
                        </h5>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
