    ...
    public function store(Request $request)
    {
        try {
            ...
            $packagedAttraction = PackagedAttraction::create([
                ...
                'senior_citizen_cost_price' => $request->senior_citizen_cost_price,
                'senior_citizen_price' => $request->senior_citizen_price,
                'adult_cost_price' => $request->adult_cost_price,
    ...
    public function update(Request $request, string $id)
    {
        try {
            $validator = Validator::make($request->all(), [
                'package_attraction_name' => 'required|string|max:255',
                'attractions' => 'required|array',
                'senior_citizen_cost_price' => 'required|numeric|min:0',
                'senior_citizen_price' => 'required|numeric|min:0',
                'adult_cost_price' => 'required|numeric|min:0',
                'adult_price' => 'required|numeric|min:0',
                'child_cost_price' => 'required|numeric|min:0',
                'child_price' => 'required|numeric|min:0',
                'description' => 'nullable|string',
