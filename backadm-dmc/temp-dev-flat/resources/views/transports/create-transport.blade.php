    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            <h5 class="card-header d-flex justify-content-between align-items-center">
                Add New Local Transport
                <a href="{{ route('transport.index') }}" class="btn btn-sm btn-outline-danger">
                    <i class="mdi mdi-arrow-left"></i> Back
                </a>
            </h5>
            <form id="transportForm" method="POST" action="{{ route('transport.store') }}" enctype="multipart/form-data"
                class="card-body">
                @csrf
                    ...
                    <div class="transport-form">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input id="vehicle_name" type="text" class="form-control" name="vehicle_name"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input id="driver_name" name="driver_name" type="text" class="form-control"
                                    placeholder="Enter driver name" required></input>
                                @error('driver_name')
                                <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input id="license_no" name="license_no" type="text" class="form-control"
                                    placeholder="Enter license no" required></input>
                                @error('license_no')
                                <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="vehicle_reg_no" class="form-label"><strong>Vehicle Reg. No</strong><span
                                        class="text-danger">*</span></label>
                                <input id="vehicle_reg_no" type="text" class="form-control" name="vehicle_reg_no"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-check form-switch">
                                <input type="hidden" name="transport_status" value="0">
                                <input class="form-check-input" name="transport_status" type="checkbox"
                                    id="transport_status" value="1">
                                <label for="transport_status" class="form-check-label"><strong>Status</strong></label>
                            </div>
                        </div>
                    </div>
