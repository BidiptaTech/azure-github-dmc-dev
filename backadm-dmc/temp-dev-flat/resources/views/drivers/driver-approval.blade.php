            ...
            <div class="card-datatable table-responsive pt-0">
                <div class="d-flex justify-content-between align-items-center" style="margin: 15px;">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0">Driver Approval</h5>
                    </div>
                ...
                <table class="datatables-basic table table-bordered">
                    ...
                    <tbody>
                        @foreach($pendingDrivers as $key => $driver)
                        <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $driver->name }}</td>
                                @php
                                ...
                                <td>{{ $driver->phone }}</td>
                                <td>
                                    <img src="{{ $driver->image }}" alt="Driver Image" class="img-thumbnail" style="width: 60px; height: 60px;">
                                </td>
                                ...
                                <td style="display: inline-block; white-space: nowrap;">
                                    ...
                                    <a href="{{ route('driver.edit.approval', $driver->driver_id) }}" 
                                    ...
                                    <button type="button" 
                                        ...
                                        onclick="setDeleteForm('{{ route('driver.destroy', $driver->driver_id) }}')">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="#ffffff">
