        ...
        <div class="col-12">
            <div class="rounded h-100 p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="mb-0">Driver Schedule</h5>
                    <div>
                ...
                <div id="driverScheduleSection" class="mt-4" style="display: none;">
                    <div class="card">
            ...
            if (driverId) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (scheduleData.length > 0) {
                                ...
                                $('#scheduleTableBody').html('<tr><td colspan="6" class="text-center">No schedule found for this driver</td></tr>');
                                $('#driverScheduleSection').show();
                            }
                        }
                    },
                    error: function(error) {
                        ...
                        $('#scheduleTableBody').html('<tr><td colspan="6" class="text-center">Error loading schedule</td></tr>');
                        $('#driverScheduleSection').show();
                    }
                });
            } else {
